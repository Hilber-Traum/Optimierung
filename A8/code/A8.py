...
if __name__ == '__main__':
    ...
    # BEGIN SOLUTION
    print("Das erweiterte Gradientenabstiegsverfahren benötigt deutlich mehr Schritte als das Newton-Verfahren und\n"
          "wird für das kleiner Tau auch erst durch die kmax Abbruchbedingung beendet.\n"
          "Das Newton-Verfahren benötigt deutlich weniger Iterationen und auch der Unterschied zwischen den beiden Tau\n"
          "ist erwartbar (aufgrund der lokalen quadratischen Konvergenz) ist in der Anzahl der iterationen nur sehr\n"
          "gering.\n"
          "Das Gradientenverfahjren ist in den ersten Iterationen deutlich schneller als im Laufe des Verfahrens.\n"
          "Logischer Weise ist dadurch auch die Laufzeit von Newton besser als die vom Gradientenabstieg,\n"
          "wobei die Laufzeit je Iteration sich nicht so stark unterscheidet.\n"
